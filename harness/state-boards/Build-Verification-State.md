...
| 2026-05-30 | rebuild Language Training three-textbook structure | `npm run build` | passed | Quartz processed 52 Markdown files and emitted 143 files; generated Learn to Read Proust, EN-CN Recomposition, and Comparative Literary Induction indexes, moved EN-CN chapters and selected comparative chapters, and kept the old Comparative-Induction working packet out of public output. |
| 2026-05-30 | refactor Daily workflow to RAW capture plus AI digest | `npm run build` | passed | Quartz processed 52 Markdown files and emitted 143 files; warnings came from unrelated untracked Language Training moves already present in the worktree. |
| 2026-05-30 | repair malformed Learn to Read Proust Chapter 001 reading layout | `npm run build` | passed | Quartz processed 52 Markdown files and emitted 143 files; local Chrome headless screenshots checked desktop 1440x900 and narrow 390x844 render for `Language-Training/LTF-Chapter-001-Cognates-and-Reading-Confidence.html`. |
