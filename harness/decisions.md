...
|---|---|---|
| Recherche / Proust is the mother star. | stable | All adjacent systems return to Proustian reading and writing. |
| Proustian is not expanding now. | stable | Avoid creating new public structures for unwritten work. |
| Current core is language training and writing thickening. | stable | These are capability lines, not generic course categories. |
...
| Public pages must not overstate completeness. | stable | Finished artifacts forward; unfinished work backstage. |
| Harness is active repo workflow context. | stable | Future Codex sessions restore state from Harness files before editing. |
...
|---|---|---|
| Which root duplicate language drafts are authoritative? | unresolved | Audit source-of-truth status before moving or archiving. |
| Which language materials are stable enough for public exposure? | unresolved | Review through Harness state boards. |
| Which Constellations texts are finished enough for public display? | unresolved | Audit existing Maps / Constellations material separately. |
