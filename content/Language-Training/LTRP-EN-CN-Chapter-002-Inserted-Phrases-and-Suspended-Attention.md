...
Location: Combray, staircase / varnish scene

Start Words: That hateful staircase

End Words: varnish upon that staircase
...
Main verb: "gave out"; "was"; "invaded."

Delayed element: The governing sensory event is delayed by "up which I always passed with such dismay."

Inserted phrase(s): "up which I always passed with such dismay"; "when it assumed this olfactory guise"; "instantaneous almost"; "a far more poisonous thing than any moral penetration."

Subordinate clause(s): "which had to some extent absorbed"; "because ... my intellect was powerless"; "When we have gone to sleep"; "so that our intelligence can disentangle."

Temporal marker(s): "always"; "each evening"; "when"; "time after time."

Sensory unit(s): smell of varnish, toothache, water, rhythmic cadence, breathing in.

Return point: "gave out a smell of varnish"; "It was the precise converse."

Completion: The smell invades consciousness more rapidly than moral thought can resist.
...
Delay: A relative phrase interrupts before the staircase can act.

Expansion: Smell absorbs, fixes, and intensifies sorrow; the sentence then adds the toothache analogy.

Suspension: The reader must hold staircase, sorrow, smell, and intellect at once.

Return: The passage returns to the varnish smell as the true force.

Completion: The final pressure is not "I was sad"; it is that smell invades consciousness before thought can defend itself.
...
```mermaid
flowchart LR
  A["Center: That hateful staircase"] --> B["Insertion: up which I always passed"]
  B --> C["Return: gave out a smell"]
  C --> D["Extension: absorbed / fixed sorrow"]
  D --> E["Insertion: olfactory guise"]
  E --> F["Analogy: toothache dream"]
  F --> G["Return: converse of relief"]
  G --> H["Completion: varnish invades consciousness"]
```

Reading use:

- Keep `A` visible while reading `B`.
...
- rhythm: whether the insertion slows or redirects breath
- delay: whether the insertion postpones the main verb or completion
- breath: whether punctuation creates a suspended pocket
- clause movement: whether the sentence resumes cleanly after the insertion
- perception: whether the insertion contains sensory or evaluative detail
- abstraction: whether the insertion explains, qualifies, or complicates perception
- emphasis: whether the insertion becomes memorable because it interrupts
...
- the difference between sentence center and inserted material
- the perceptual value of interruption
- the return to the governing structure
- the feeling that attention has been suspended, not reset

Decide:

- Can the insertion remain inside the Chinese sentence?
- Should it become a short interior phrase set off by punctuation?
...
|---|---|---|---|
| "That hateful staircase" anchors the sentence | Lose the staircase under explanation | Keep staircase as the visible center | Can the reader still see what governs the sentence? |
| "up which I always passed" interrupts the subject | Delete or flatten the relative clause | Preserve habitual passage as suspended material | Does the interruption thicken the staircase? |
| "gave out a smell of varnish" returns through smell | Translate smell as a minor detail | Make smell the governing sensory event | Does the sentence return through smell? |
...
What it does: Suspends the governing sentence by inserting perception, qualification, or descriptive pressure.

How to recognize it: The sentence can resume after the bracketed phrase; the inserted material enriches the movement without becoming the main clause.

How to practice it: Bracket insertions, draw an arrow from the opening structure to its return point, then test Chinese placements.

Proustian function: Perception enters through interruption, forcing attention to hold structure and atmosphere together.

Chinese adaptation: Keep the insertion's pressure while choosing whether Chinese needs embedding, repositioning, or strategic division.
