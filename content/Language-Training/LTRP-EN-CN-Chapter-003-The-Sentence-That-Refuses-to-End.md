...
Location: Combray, after the night of the mother's visit

Start Words: Even at the moment

End Words: Go and comfort him
...
Main verb: "was"; "deserved"; "had prevented"; "knew"; "loved"; "doubt"; "had said."

Delayed element: The final practical action, "Go and comfort him," arrives after a chain of qualifications.

Inserted phrase(s): "when it manifested itself in this crowning mercy"; "when he sent me off to bed"; "which in some respects differed more than theirs from my own"; "whose affection for me was of another kind."

Subordinate clause(s): "due to the fact that"; "rather than based"; "for his nature"; "until then"; "which my mother and grandmother knew well"; "so as to reduce."

Temporal marker(s): "Even at the moment"; "when"; "until then"; "every evening"; "as soon as."

Sensory unit(s): none dominant; the pressure is ethical and psychological rather than sensory.

Return point: "As for my father" returns the chain to the father's different mode of affection.

Completion: Direct speech closes the long evaluative chain with action.
...
Delay: Each judgment is extended by cause, contrast, temperament, and remembered habit.

Expansion: The sentence expands from conduct to strictness, from strictness to temperament, from temperament to parental knowledge, from knowledge to training the will.

Suspension: The reader cannot settle on "strict" or "kind" too early.

Return: The passage returns to the father as a different kind of affection.

Completion: "Go and comfort him" matters because it comes after long moral and psychological qualification.
...
```mermaid
flowchart LR
  A["Judgment: father's conduct was arbitrary"] --> B["Cause: characteristic of him"]
  B --> C["Revision: strictness deserved the title less"]
  C --> D["Insertion: when he sent me off to bed"]
  D --> E["Cause: his nature differed"]
  E --> F["Extension: did not guess my misery"]
  F --> G["Contrast: mother / grandmother knew"]
  G --> H["Purpose: strengthen my will"]
  H --> I["Return: father's affection was different"]
  I --> J["Completion: Go and comfort him"]
```

Reading use:

- Do not reduce the passage to "the father was kinder."
...
- rhythm: repeated extensions, commas, and breath units
- delay: postponed closure across several additions
- breath: where the sentence can pause without ending
- clause movement: whether each clause depends on the last or on the main structure
- perception: sensory accumulation through sequence
- abstraction: qualifications that refine a thought before it closes
- emphasis: the final element gains weight because it follows a chain
...
- the pressure of not-yet-finished thought
- the relation between each added unit and the sentence center
- the final arrival after continuation

Decide:

- Which extensions must remain in one Chinese sentence?
- Which can become semicolon-like units?
- Can punctuation create continuation without forcing a single overloaded sentence?
- Does the Chinese draft keep moving, or does it become a list?
...
|---|---|---|---|
| Judgment begins with "father's conduct" | Translate as a fixed moral conclusion | Keep judgment provisional | Does the Chinese allow revision? |
| "as was characteristic of him" extends cause | Turn it into a separate abstract comment | Keep it attached to the judgment | Does cause still modify the conduct? |
| "when he sent me off to bed" inserts scene | Lose the scene inside explanation | Mark it as remembered circumstance | Does the event interrupt the judgment? |
...
What it does: Extends a sentence through linked clauses, sensory additions, qualifications, or delayed completion.

How to recognize it: The sentence reaches several possible stopping points but continues because perception or thought is still unfolding.

How to practice it: Number each extension and label what it contributes before drafting Chinese.

Proustian function: Extension lets perception accumulate until the sentence becomes a chamber of attention.

Chinese adaptation: Preserve continuation through sequence, punctuation, and controlled division rather than automatic shortening.
