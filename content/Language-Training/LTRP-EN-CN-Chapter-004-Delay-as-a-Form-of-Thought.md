...
```mermaid
flowchart LR
  A["Ordinary object: petites madeleines"] --> B["Mechanical action: raised tea"]
  B --> C["Sensory contact: warm liquid / crumbs"]
  C --> D["Bodily shock: shudder"]
  D --> E["Suspended origin: no suggestion"]
  E --> F["Life altered: disasters innocuous"]
  F --> G["Correction: not in me, it was myself"]
  G --> H["Inquiry: Whence did it come?"]
```
