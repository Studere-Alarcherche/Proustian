...
- Web App textual observatory
- Quartz archive garden
- Learn to Read Proust
- Textual Promenade
- Build Log
- Public essays and WeChat writing
...
- TURN
- MEMORY / NAME / LOVE / WORLD / SENSE / ART
- WRITING

Observation Chamber:

- central text
- French / English / Chinese switch
- theory lens I
- theory lens II
- scene pressure I
- scene pressure II
...
- `.codex/skills/`
- repo-local project-specific skill instructions

Human Documentation Layer:

- `skills/README.md`
- `skills/EXTERNAL-SKILLS.md`
- `skills/PROJECT-SKILLS.md`

Quartz Archive Layer:

- `content/`
- public essays
- Learn to Read Proust public chapters
- Textual Promenade public versions
- Build Log pages

Web App Layer:

- `app/`
- future Vite + React + TypeScript shell
- currently documentation only unless explicitly approved
...
Archive / Deprecated Layer:

- `_archive/`
- only for explicitly archived repo-level material

## Current Operating Rules

- Keep Proust at the center.
- Treat Deleuze as a method lens, not a top-level replacement topic.
